(function () {
    ...
    function boot () {
        ...
        if (!false) {
            var bundledScript = settings.debug ? 'src/project.dev.js' : 'src/project.13eb1.js';
            if (jsList) {
    ...
    if (false) {
        require(window._CCSettings.debug ? 'cocos2d-js.js' : 'cocos2d-js-min.f9a10.js');
    ...
    if (window.document) {
        ...
        cocos2d.async = true;
        cocos2d.src = window._CCSettings.debug ? 'cocos2d-js.js' : 'cocos2d-js-min.f9a10.js';
